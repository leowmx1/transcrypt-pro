...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    createSafebox: (options) => ipcRenderer.invoke('create-safebox', options),
    mountSafebox: (options) => ipcRenderer.invoke('mount-safebox', options),
    unmountSafebox: (options) => ipcRenderer.invoke('unmount-safebox', options),
    listSafeboxSessions: () => ipcRenderer.invoke('list-safebox-sessions'),
